...
class TestCreateUser:
    ...
    def test_create_user(self, default_user):
        assert default_user.status_code == 200 and TestDataBody.body_keys in TestDataBody.BODY_OK_REGISTRATION_AUTH
    ...
    def test_same_user(self, payload_data):
        response = requests.post(urls.URL_BASE + urls.URL_REG_USER, data=payload_data)
